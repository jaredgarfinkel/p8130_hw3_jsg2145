...
The standard deviation of the groups can be considered to be the standard deviation
...
= $\frac{(2.2+0.54)(z_{1-\alpha/2}+z_{1-\beta})^2}{(.5)^2}$
...
= `r (2.2+54/2)*(1.96+.84)^2/.5^2` = 915.7 ~ 916

$n_2 = \frac{(2*2.2+0.54)(z_{1-\alpha/2}+z_{1-\beta})^2}{(.5)^2}$

= `r (2*2.2+54)*(1.96+.84)^2/.5^2` = 1831.4 ~ 1832
